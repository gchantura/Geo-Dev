...
<script>
	import GetInfoFromCustomer from '../../Components/Images/Page_Images/Get_Info_From_Customer.jpeg';
	import AnalizeInformation from '../../Components/Images/Page_Images/Analizing_Data.jpeg';
</script>
	...
	<section>
		...
		<div class="mb-16 flex flex-wrap">
			<div class="mb-6 w-full shrink-0 grow-0 basis-auto lg:mb-0 lg:w-6/12 lg:pr-6">
				...
				>
					<img
						src={GetInfoFromCustomer}
						class="relative h-128 w-full bg-cover"
						alt="Tailwind Play"
					/>
					<a href="#!">
						<div
			...
			<div class="w-full shrink-0 grow-0 basis-auto lg:w-6/12 lg:pl-6">
				...
				<p class="leading-loose tracking-wider text-neutral-500 dark:text-neutral-300">
					...
					ინფორმაცია. შეკვეთების მენეჯერი გადაცემს შეკვეთას შესაბამის ჯგუფს რომელიც განიხილავს
					თქვენს მოთხოვნას და ინფორმაციას. რის შემდეგ, ხდება პროცედურულად განხილვა თუ რა ინფორმაციას
					საჭიროებს დეველოპერთა ჯგუფი და ასევე რა ინფორმაცია უნდა მიეწოდოს შემკვეთს. რის სემდეგ
					ჩვენი შეკვეთების მენეჯერი ახდენს ინფორმაციის სორტირებას და ნიშნავს სატელეფონო ზარს ან
					შეხვედრას.
				</p>
				<p class="text-neutral-500 dark:text-neutral-300"></p>
			</div>
		</div>
		...
		<div class="mb-16 flex flex-wrap lg:flex-row-reverse">
			...
			<div class="w-full shrink-0 grow-0 basis-auto lg:w-6/12 lg:pr-6">
				...
				<div class="text-primary mb-4 flex items-center text-sm font-medium dark:text-primary-400">
					<svg
				...
				<p class="text-neutral-500 dark:text-neutral-300">
					...
					faucibus imperdiet. Proin tempor lorem at neque tempus aliquet. Phasellus at ex volutpat,
					varius arcu id, aliquam lectus. Vestibulum mattis felis quis ex pharetra luctus. Etiam
		...
		<div class="flex flex-wrap">
			...
			<div class="w-full shrink-0 grow-0 basis-auto lg:w-6/12 lg:pl-6">
				...
				<p class="text-neutral-500 dark:text-neutral-300">
					Sed sollicitudin purus sed nulla dignissim ullamcorper. Aenean tincidunt vulputate libero,
					nec imperdiet sapien pulvinar id. Nullam scelerisque odio vel lacus faucibus, tincidunt
					feugiat augue ornare. Proin ac dui vel lectus eleifend vestibulum et lobortis risus.
					Nullam in commodo sapien. Curabitur ut erat congue sem finibus eleifend egestas eu metus.
					Sed ut dolor id magna rutrum ultrices ut eget libero. Duis vel porttitor odio. Ut pulvinar
					sed turpis ornare tincidunt. Donec luctus, mi euismod dignissim malesuada, lacus lorem
					commodo leo, tristique blandit ante mi id metus. Integer et vehicula leo, vitae interdum
					lectus. Praesent nulla purus, commodo at euismod nec, blandit ultrices erat. Aliquam eros
					ipsum, interdum et mattis vitae, faucibus vitae justo. Nulla condimentum hendrerit leo, in
